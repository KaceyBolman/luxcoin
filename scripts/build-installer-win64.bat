...
set LUX_VERSION_DEFAULT=local-dev-build-%CARDANO_BRANCH_DEFAULT%
...
move   node_modules\lux-client-api\cardano-node.exe     installers\
move   node_modules\lux-client-api\cardano-launcher.exe installers\
