...
const messages = defineMessages({
  ...
  updateMessage: {
    ...
    defaultMessage: '!!!Lux and Cardano node update is available. Would you like to install the update?',
    description: 'Message shown when there is a Lux and Cardano node update available.'
  },
});
